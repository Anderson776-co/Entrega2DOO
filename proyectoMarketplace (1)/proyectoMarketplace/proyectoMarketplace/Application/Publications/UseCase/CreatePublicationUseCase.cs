...
namespace Application.Publications.UseCase
{
    public class CreatePublicationUseCase
    {
        ...
        public CreatePublicationUseCase(PublicationService publicationService, IImageService imageService)
        {
            _publicationService = publicationService;
            _imageService = imageService;
        }

        public async Task<PublicationResponseDTO> Create(PublicationDTO dto, int userId, Stream? imageStream, string? fileName)
        {
            var imageUrl = "";
            ...
            var createdPublicationEntity = await _publicationService.Create(publicationEntity, productEntity);
            var PublicationResponse = PublicationResponseDTO.FromEntityToDTO(createdPublicationEntity);
